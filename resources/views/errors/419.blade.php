...
<head>
    <meta charset="UTF-8">
    <title>Sessão expirada — Luanda Tickets</title>
...
<body class="text-white bg-slate-900 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center pt-16 px-4">
        <div class="text-center fade-in max-w-md">
            ...
            <h1 class="text-8xl font-black text-yellow-400 mb-2">419</h1>
            <h2 class="text-2xl font-bold text-white mb-3">Sessão expirada</h2>
            <p class="text-gray-400 mb-8 leading-relaxed">
                A tua sessão expirou por inatividade. Recarrega a página e tenta novamente.
            </p>
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                <button onclick="window.location.reload()"
                        class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-3 rounded-2xl transition">
                    🔄 Recarregar página
                </button>
                <a href="{{ route('home') }}"
