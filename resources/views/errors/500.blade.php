...
<head>
    <meta charset="UTF-8">
    <title>Erro do servidor — Luanda Tickets</title>
...
<body class="text-white bg-slate-900 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center pt-16 px-4">
        <div class="text-center fade-in max-w-md">
            <div class="float text-8xl mb-6">⚙️</div>
            <h1 class="text-8xl font-black text-red-500 mb-2">500</h1>
            <h2 class="text-2xl font-bold text-white mb-3">Erro interno do servidor</h2>
            <p class="text-gray-400 mb-8 leading-relaxed">
                Algo correu mal da nossa parte. Já estamos a trabalhar para resolver. Tenta novamente em breve.
            </p>
