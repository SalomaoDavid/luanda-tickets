...
<head>
    <meta charset="UTF-8">
    <title>Acesso proibido — Luanda Tickets</title>
...
<body class="text-white bg-slate-900 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center pt-16 px-4">
        <div class="text-center fade-in max-w-md">
            ...
            <h1 class="text-8xl font-black text-red-400 mb-2">403</h1>
            <h2 class="text-2xl font-bold text-white mb-3">Acesso proibido</h2>
            <p class="text-gray-400 mb-8 leading-relaxed">
                Não tens permissão para aceder a esta página ou realizar esta ação.
            </p>
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="javascript:history.back()"
                   class="border border-gray-500 text-gray-400 hover:bg-gray-700 font-semibold px-6 py-3 rounded-2xl transition">
                    ← Página anterior
                </a>
            </div>
        </div>
